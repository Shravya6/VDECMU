...
form button:hover,form button:active,form button:focus {
  background: #43A047;
    ...
    <body>
        ...
        <form action="RoleDelegationRAction.jsp">
        <table border="0">
            <tbody>
                <tr>
                    <td>Delegation ID</td>
...
ResultSet rs2=st2.executeQuery("select DEPARTMENT from PROFESSOR where PROFESSOR_ID='"+sid+"'");rs2.next();
        ...
        <p>Reason</p>
        <textarea name="reason" rows="6" cols="25"placeholder="reason" required>
        </textarea>
        <p>

<%-- 
    Document   : RoleDelegation3
    Created on : 4 Jul, 2018, 12:59:57 PM
    Author     : B Shravya
--%>
...
<html>
    ...
    <%
        ...
        if(id1.equals(id)){
        PreparedStatement ps=con.prepareStatement("update PROFESSOR set STATUS='delegated' where PROFESSOR_ID='"+fid+"'");
